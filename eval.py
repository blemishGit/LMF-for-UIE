...
parser.add_argument('--data_test', type=str, default='./Dataset/UIE/LSUI/input-SHAIXUAN')
parser.add_argument('--label_test', type=str, default='./Dataset/UIE/LSUI/label-SHAIXUAN')
...
parser.add_argument('--model', default='/home/estar/Documents/UIE/Ours/Mamba-UIE-main/weights/epoch_185.pth', help='Pretrained base model'   )
# parser.add_argument('--model', default='weights/UIEB.pth', help='Pretrained base model')
parser.add_argument('--output_folder', type=str, default='./results-LSUI-A/')
